...
export default function News() {
              ...
              {[1, 2, 3].map((i) => (
                <div key={i} className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 md:p-8">
                  <div className="animate-pulse space-y-4">
                    ...
                    <div className="bg-gray-200 h-3 rounded-md w-1/3 mt-4"></div>
                  </div>
                </div>
              ))}
            </div>
  ...
  return (
    <section id="news" className="py-16 md:py-20 bg-gradient-to-br from-gray-50 to-white">
      <div className="container mx-auto px-4">
        <div className="max-w-7xl mx-auto">
          {/* Header */}
          <div className="text-center mb-12 md:mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              <span className="text-gray-900">News &</span> <span className="text-blue-700">Announcements</span>
            </h2>
